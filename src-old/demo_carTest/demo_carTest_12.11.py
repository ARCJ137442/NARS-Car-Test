...
class Constants:
    ...
    #过程数据txt文件名称
    txt_name = ['2_1_1','2_1_2','2_2_1','2_2_2','2_3_1','2_3_2']
    TXT_NAME = txt_name[0] + '.txt'
    EXCEL_NAME = txt_name[0] + '.xlsx'
    #测试文件位置
    ...
    #十次重复实验
    sheet_name = ['2_1_1','2_1_2','2_1_3','2_1_4','2_2_1','2_2_2','2_2_3','2_2_4','2_3_1','2_3_2','2_3_3','2_3_4']
...
class Game:
    ...
    def move_left(self):
        ...
        self.send_to_nars("<{SELF} --> [safe]>. :|: %0.2% ")  # 每走一步消耗能量，降低safe
        # 这里也许有推理时间
    ...
    def __display_text_babble(self):
        ...
        self.print_process(Constants.NARS_PROCESS,70,230,'nars')
    ...
    def write_process_txt(self):
        ...
        for i in range(1,len(Constants.NARS_PROCESS)+1):
            ...
            if i%10 == 0 :
                ...
                f.write(',')
            i += 1
        f.write('\n' + 'L_S_COUNT: %d' % N_LS_count + ';  R_S_COUNT: %d' % N_RS_count + ' .\n')
        f.close()
...
if __name__ =='__main__':
    ...
    #常识输入
    game.send_to_nars('<{SELF} --> [safe] > %0.5%:|:')   #一开始并不确定是否安全
